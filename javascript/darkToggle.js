...
export function themeSet(){
    if (localStorage.getItem("theme")==="dark"){
        ...
        function backLightImage(){
            i+=1;
            document.querySelector(".hero-heading").style.backgroundImage=`url('https://${location.hostname}/art-Warp/styles/images/hero-light/hero${i}.jpeg')`;
            i===4?i=-1:null;
...
function toDark(){
    ...
    if (document.getElementById("nft-theme")){
        ...
        function backDarkImage(){
            j+=1;
            document.querySelector(".hero-heading").style.backgroundImage=`url('https://${location.hostname}/art-Warp/styles/images/hero-dark/hero${j}.jpeg')`;
            j===5?j=-1:null;
